...
sealed class PokemonTypes(val typeName: String, val icon: Int, val PokemonColor: PokemonColors) {
    object Normal: PokemonTypes("normal", R.drawable.electric_icon, PokemonColors.GrayNormal)
    object Fighting: PokemonTypes("fighting", R.drawable.electric_icon, PokemonColors.GrayAcero)
    object Flying: PokemonTypes("flying", R.drawable.electric_icon, PokemonColors.BlueFly)
    object Poison: PokemonTypes("poison", R.drawable.electric_icon, PokemonColors.PurplePoison)
    object Ground: PokemonTypes("ground", R.drawable.electric_icon, PokemonColors.Brown)
    object Rock: PokemonTypes("rock", R.drawable.electric_icon, PokemonColors.Brown)
    object Bug: PokemonTypes("bug", R.drawable.electric_icon, PokemonColors.Green)
    object Ghost: PokemonTypes("ghost", R.drawable.electric_icon, PokemonColors.PurpleGhost)
    object Steel: PokemonTypes("steel", R.drawable.electric_icon, PokemonColors.GrayAcero)
    object Fire: PokemonTypes("fire", R.drawable.fire_icon, PokemonColors.RedFire)
    object Water: PokemonTypes("water", R.drawable.electric_icon, PokemonColors.BlueWater)
    ...
    object Shadow: PokemonTypes("shadow", R.drawable.electric_icon, PokemonColors.Black)
